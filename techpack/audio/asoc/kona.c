...
static struct snd_soc_dai_link_component cs35l41_codec_components_alioth[] = {
	{
		.name = "cs35l41.1-0040",
...
static struct snd_soc_dai_link_component cs35l41_codec_components_elienu[] = {
	{
		.name = "cs35l41.1-0040",
		.dai_name = "cs35l41.1-0040",
	},
...
static struct snd_soc_dai_link_component cs35l41_codec_components_sm8250[] = {
	{
		.name = "cs35l41.1-0040",
		.dai_name = "cs35l41.1-0040",
	},
...
static struct snd_soc_codec_conf cs35l41_codec_conf_alioth[] = {
	{
		.dev_name	= "cs35l41.1-0040",
		.name_prefix	= "SPK",
	},
	{
		.dev_name	= "cs35l41.1-0041",
		.name_prefix	= "RCV",
	},
};

static struct snd_soc_codec_conf cs35l41_codec_conf_sm8250[] = {
	{
		.dev_name	= "cs35l41.1-0040",
		.name_prefix	= "SPK",
	},
	{
		.dev_name	= "cs35l41.1-0042",
		.name_prefix	= "RCV",
	},
};
#elif defined(CONFIG_MACH_XIAOMI_SM7250)
static struct snd_soc_dai_link_component cs35l41_codec_components_sm7250[] = {
	{
		.name = "cs35l41.2-0040",
		.dai_name = "cs35l41.2-0040",
	},
...
static struct snd_soc_codec_conf cs35l41_codec_conf_sm7250[] = {
	{
...
static struct tdm_dev_config tert_tdm_dev_elienu_config[MAX_PATH][TDM_PORT_MAX] = {
	{ /* TERT TDM */
...
#ifdef CONFIG_MACH_XIAOMI_SM8250
static void *tdm_elienu_cfg[TDM_INTERFACE_MAX] = {
	pri_tdm_dev_config,
	sec_tdm_dev_config,
	tert_tdm_dev_elienu_config,
	quat_tdm_dev_config,
	quin_tdm_dev_config,
	sen_tdm_dev_config,
};
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	if (socinfo_get_platform_type() == HW_PLATFORM_ELISH ||
		...
		config = ((struct tdm_dev_config *) tdm_elienu_cfg[interface / MAX_PATH]) +
				     ...
				     struct snd_pcm_hw_params *params)
{
	...
	if (socinfo_get_platform_type() == HW_PLATFORM_ELISH ||
	    socinfo_get_platform_type() == HW_PLATFORM_ENUMA)
		config = ((struct tdm_dev_config *) tdm_elienu_cfg[interface]) +
...
#ifdef CONFIG_MACH_XIAOMI_SM8250
static struct snd_soc_dai_link cs35l41_alioth_dai_link = {
	...
	.codecs = cs35l41_codec_components_alioth,
	.num_codecs = ARRAY_SIZE(cs35l41_codec_components_alioth),
	.be_hw_params_fixup = msm_be_hw_params_fixup,
	.ignore_suspend = 1,
	.ignore_pmdown_time = 1,
};

static struct snd_soc_dai_link cs35l41_apocas_dai_link = {
	.name = "Tertiary TDM1 Hostless Playback",
	.stream_name = "Tertiary TDM1 Hostless Playback",
	.cpu_dai_name = "msm-dai-q6-tdm.36898",
	.platform_name = "msm-pcm-hostless",
	...
	.ops = &kona_tdm_be_ops,
	.id = MSM_BACKEND_DAI_TERT_TDM_RX_1,
	.codecs = cs35l41_codec_components_sm8250,
	.num_codecs = ARRAY_SIZE(cs35l41_codec_components_sm8250),
	.be_hw_params_fixup = msm_be_hw_params_fixup,
	.ignore_suspend = 1,
	.ignore_pmdown_time = 1,
};

static struct snd_soc_dai_link cs35l41_elienu_dai_link = {
	.name = "Tertiary TDM1 Hostless Playback",
	.stream_name = "Tertiary TDM1 Hostless Playback",
	.cpu_dai_name = "msm-dai-q6-tdm.36898",
	.platform_name = "msm-pcm-hostless",
	...
	.ops = &kona_tdm_be_ops,
	.id = MSM_BACKEND_DAI_TERT_TDM_RX_1,
	.codecs = cs35l41_codec_components_elienu,
	.num_codecs = ARRAY_SIZE(cs35l41_codec_components_elienu),
	.be_hw_params_fixup = msm_be_hw_params_fixup,
	.ignore_suspend = 1,
	.ignore_pmdown_time = 1,
};

static struct snd_soc_dai_link cs35l41_thyme_dai_link = {
	.name = "CDC_DMA Hostless",
	.stream_name = "CDC_DMA Hostless",
...
static struct snd_soc_dai_link cs35l41_sm8250_dai_link = {
	.name = "CDC_DMA Hostless",
	.stream_name = "CDC_DMA Hostless",
	.cpu_dai_name = "msm-dai-cdc-dma-dev.45106",
	.platform_name = "msm-pcm-hostless",
...
#ifdef CONFIG_MACH_XIAOMI_SM8250
static struct snd_soc_dai_link tert_mi2s_rx_cs35l41_dai_links_alioth[] = {
	{
		.name = LPASS_BE_TERT_TDM_RX_0,
		.stream_name = "Tertiary TDM0 Playback",
		.cpu_dai_name = "msm-dai-q6-tdm.36896",
...
static struct snd_soc_dai_link tert_mi2s_rx_cs35l41_dai_links_apocas[] = {
	{
		.name = LPASS_BE_TERT_TDM_RX_0,
		.stream_name = "Tertiary TDM0 Playback",
		.cpu_dai_name = "msm-dai-q6-tdm.36896",
...
static struct snd_soc_dai_link tert_mi2s_rx_cs35l41_dai_links_elienu[] = {
	{
		.name = LPASS_BE_TERT_TDM_RX_0,
		.stream_name = "Tertiary TDM0 Playback",
		.cpu_dai_name = "msm-dai-q6-tdm.36896",
...
static struct snd_soc_dai_link tert_mi2s_rx_cs35l41_dai_links_sm8250[] = {
	{
		.name = LPASS_BE_TERT_MI2S_RX,
		.stream_name = "Tertiary MI2S Playback",
		.cpu_dai_name = "msm-dai-q6-mi2s.2",
...
static struct snd_soc_dai_link pri_mi2s_rx_tfa9874_dai_links_sm8250[] = {
	{
		.name = LPASS_BE_PRI_MI2S_RX,
		.stream_name = "Primary MI2S Playback",
		.cpu_dai_name = "msm-dai-q6-mi2s.0",
...
#elif defined(CONFIG_MACH_XIAOMI_SM7250)
static struct snd_soc_dai_link sec_mi2s_rx_tfa9874_be_dai_links_sm7250[] = {
	{
		.name = LPASS_BE_SEC_MI2S_RX,
		.stream_name = "Secondary MI2S Playback",
		.cpu_dai_name = "msm-dai-q6-mi2s.1",
...
static struct snd_soc_dai_link sec_mi2s_rx_cs35l41_dai_links_sm7250[] = {
	{
		.name = LPASS_BE_SEC_MI2S_RX,
		.stream_name = "Secondary MI2S Playback",
		.cpu_dai_name = "msm-dai-q6-mi2s.1",
		.platform_name = "msm-pcm-routing",
		.codecs = cs35l41_codec_components_sm7250,
		.num_codecs = ARRAY_SIZE(cs35l41_codec_components_sm7250),
		.no_pcm = 1,
		.dpcm_playback = 1,
		.id = MSM_BACKEND_DAI_SECONDARY_MI2S_RX,
		.be_hw_params_fixup = msm_be_hw_params_fixup,
...
#if defined(CONFIG_MACH_XIAOMI_SM8250)
			ARRAY_SIZE(tert_mi2s_rx_cs35l41_dai_links_alioth) +
			ARRAY_SIZE(tert_mi2s_rx_cs35l41_dai_links_apocas) +
			ARRAY_SIZE(tert_mi2s_rx_cs35l41_dai_links_elienu) +
			ARRAY_SIZE(tert_mi2s_rx_cs35l41_dai_links_sm8250) +
			ARRAY_SIZE(pri_mi2s_rx_tfa9874_dai_links_sm8250) +
#elif defined(CONFIG_MACH_XIAOMI_SM7250)
			ARRAY_SIZE(sec_mi2s_rx_tfa9874_be_dai_links_sm7250) +
			ARRAY_SIZE(sec_mi2s_rx_cs35l41_dai_links_sm7250) +
#endif
...
#ifdef CONFIG_MACH_XIAOMI_SM8250
struct snd_soc_card snd_soc_card_stub_msm_alioth = {
	.name		= "kona-stub-snd-card",
	.codec_conf	= cs35l41_codec_conf_alioth,
	.num_configs	= ARRAY_SIZE(cs35l41_codec_conf_alioth),
};
#endif
...
struct snd_soc_card snd_soc_card_stub_msm = {
	.name		= "kona-stub-snd-card",
#if defined(CONFIG_MACH_XIAOMI_SM8250)
	.codec_conf	= cs35l41_codec_conf_sm8250,
	.num_configs	= ARRAY_SIZE(cs35l41_codec_conf_sm8250),
#elif defined(CONFIG_MACH_XIAOMI_SM7250)
	.codec_conf	= cs35l41_codec_conf_sm7250,
	.num_configs	= ARRAY_SIZE(cs35l41_codec_conf_sm7250),
#endif
};
...
#ifdef CONFIG_MACH_XIAOMI_SM8250
	int i = 0;
	struct snd_soc_dai_link *temp_dai_link = NULL;
#endif
#endif

#ifdef CONFIG_MACH_XIAOMI
	platform = socinfo_get_platform_type();
#endif
...
#ifdef CONFIG_MACH_XIAOMI_SM8250
		for (i=0; i < ARRAY_SIZE(msm_common_dai_links); i++) {
			temp_dai_link = &msm_common_dai_links[i];

			if (!temp_dai_link->name)
				continue;
			if (!!strcmp(temp_dai_link->name, "CDC_DMA Hostless"))
				continue;

			if (platform == HW_PLATFORM_ALIOTH) {
				memcpy(temp_dai_link, &cs35l41_alioth_dai_link, sizeof(cs35l41_alioth_dai_link));
			} else if (platform == HW_PLATFORM_APOLLO ||
			           platform == HW_PLATFORM_CAS) {
				memcpy(temp_dai_link, &cs35l41_apocas_dai_link, sizeof(cs35l41_apocas_dai_link));
			} else if (platform == HW_PLATFORM_ENUMA ||
			           platform == HW_PLATFORM_ELISH) {
				memcpy(temp_dai_link, &cs35l41_elienu_dai_link, sizeof(cs35l41_elienu_dai_link));
			} else if (platform == HW_PLATFORM_THYME) {
				memcpy(temp_dai_link, &cs35l41_thyme_dai_link, sizeof(cs35l41_thyme_dai_link));
			} else {
				memcpy(temp_dai_link, &cs35l41_sm8250_dai_link, sizeof(cs35l41_sm8250_dai_link));
			}
		...
		if (rc) {
			...
			if (mi2s_audio_intf) {
				...
				total_links +=
					ARRAY_SIZE(msm_mi2s_be_dai_links);
#if defined(CONFIG_MACH_XIAOMI_SM8250)
				if (platform == HW_PLATFORM_LMI) {
					memcpy(msm_kona_dai_links + total_links,
						pri_mi2s_rx_tfa9874_dai_links_sm8250,
						sizeof(pri_mi2s_rx_tfa9874_dai_links_sm8250));
					total_links += ARRAY_SIZE(pri_mi2s_rx_tfa9874_dai_links_sm8250);
					dev_info(dev, "%s: Using pri_mi2s_rx_tfa9874_dai_links_sm8250\n", __func__);
				} else if (platform == HW_PLATFORM_ALIOTH) {
					memcpy(msm_kona_dai_links + total_links,
						tert_mi2s_rx_cs35l41_dai_links_alioth,
						sizeof(tert_mi2s_rx_cs35l41_dai_links_alioth));
					total_links += ARRAY_SIZE(tert_mi2s_rx_cs35l41_dai_links_alioth);
					dev_info(dev, "%s: Using tert_mi2s_rx_cs35l41_dai_links_alioth\n", __func__);
				} else if (platform == HW_PLATFORM_APOLLO ||
				           platform == HW_PLATFORM_CAS) {
					memcpy(msm_kona_dai_links + total_links,
						tert_mi2s_rx_cs35l41_dai_links_apocas,
						sizeof(tert_mi2s_rx_cs35l41_dai_links_apocas));
					total_links += ARRAY_SIZE(tert_mi2s_rx_cs35l41_dai_links_apocas);
					dev_info(dev, "%s: Using tert_mi2s_rx_cs35l41_dai_links_apocas\n", __func__);
				} else if (platform == HW_PLATFORM_ENUMA ||
				           platform == HW_PLATFORM_ELISH) {
					memcpy(msm_kona_dai_links + total_links,
						tert_mi2s_rx_cs35l41_dai_links_elienu,
						sizeof(tert_mi2s_rx_cs35l41_dai_links_elienu));
					total_links += ARRAY_SIZE(tert_mi2s_rx_cs35l41_dai_links_elienu);
					dev_info(dev, "%s: Using tert_mi2s_rx_cs35l41_dai_links_elienu\n", __func__);
				} else if (platform == HW_PLATFORM_UMI ||
				           platform == HW_PLATFORM_CMI ||
				           platform == HW_PLATFORM_THYME) {
					memcpy(msm_kona_dai_links + total_links,
						tert_mi2s_rx_cs35l41_dai_links_sm8250,
						sizeof(tert_mi2s_rx_cs35l41_dai_links_sm8250));
					total_links += ARRAY_SIZE(tert_mi2s_rx_cs35l41_dai_links_sm8250);
					dev_info(dev, "%s: Using tert_mi2s_rx_cs35l41_dai_links_sm8250\n", __func__);
				}
#elif defined(CONFIG_MACH_XIAOMI_SM7250)
				if (platform == HW_PLATFORM_PICASSO) {
					memcpy(msm_kona_dai_links + total_links,
						sec_mi2s_rx_tfa9874_be_dai_links_sm7250,
						sizeof(sec_mi2s_rx_tfa9874_be_dai_links_sm7250));
					total_links += ARRAY_SIZE(sec_mi2s_rx_tfa9874_be_dai_links_sm7250);
				} else if (platform == HW_PLATFORM_MONET ||
				           platform == HW_PLATFORM_VANGOGH) {
				    memcpy(msm_kona_dai_links + total_links,
					    sec_mi2s_rx_cs35l41_dai_links_sm7250,
					    sizeof(sec_mi2s_rx_cs35l41_dai_links_sm7250));
				    total_links += ARRAY_SIZE(sec_mi2s_rx_cs35l41_dai_links_sm7250);
				}
#endif
			}
		}
...
#ifdef CONFIG_MACH_XIAOMI_SM8250
		card = (platform == HW_PLATFORM_ALIOTH) ? &snd_soc_card_stub_msm_alioth
		                                              : &snd_soc_card_stub_msm;
#else
