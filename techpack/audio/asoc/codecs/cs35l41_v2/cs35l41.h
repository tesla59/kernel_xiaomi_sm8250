...
bool cs35l41_v2_readable_reg(struct device *dev, unsigned int reg);
bool cs35l41_v2_precious_reg(struct device *dev, unsigned int reg);
bool cs35l41_v2_volatile_reg(struct device *dev, unsigned int reg);

struct cs35l41_v2_otp_packed_element_t {
	u32 reg;
	u8 shift;
	u8 size;
};

struct cs35l41_v2_otp_map_element_t {
	u32 devid_otp;
	u32 id;
	u32 num_elements;
	const struct cs35l41_v2_otp_packed_element_t *map;
	u32 bit_offset;
	u32 word_offset;
};

struct cs35l41_v2_otp_trim_region_t {
	u32 reg;
	u8 size;
};

struct cs35l41_v2_otp_maps {
	const struct cs35l41_v2_otp_map_element_t *map;
	int len;
};

extern const struct reg_default cs35l41_v2_reg[CS35L41_MAX_CACHE_REG];
extern const struct cs35l41_v2_otp_maps cs35l41_v2_otp_maps;
...
extern const unsigned int cs35l41_v2_ctl_cache_regs[CS35L41_CTRL_CACHE_SIZE];
extern const struct cs35l41_v2_otp_trim_region_t
			cs35l41_v2_trim_cache_regs[CS35L41_TRIM_CACHE_REGIONS];

enum cs35l41_v2_cspl_mboxstate {
...
enum cs35l41_v2_hibernate_state {
