...
const struct reg_default cs35l41_v2_reg[CS35L41_MAX_CACHE_REG] = {
...
static const struct cs35l41_v2_otp_packed_element_t
					otp_map_1[] = {
	/* addr         shift   size */
...
const struct cs35l41_v2_otp_maps cs35l41_v2_otp_maps = {
	.map = cs35l41_otp_map_map,
	.len = ARRAY_SIZE(cs35l41_otp_map_map),
};


const unsigned int cs35l41_v2_ctl_cache_regs[CS35L41_CTRL_CACHE_SIZE] = {
...
const struct cs35l41_v2_otp_trim_region_t
