...
#ifndef __CS35L41_V2_H
#define __CS35L41_V2_H

struct classh_cfg_v2 {
...
struct cs35l41_v2_platform_data {
	bool sclk_frc;
	bool lrclk_frc;
	bool right_channel;
	bool amp_gain_zc;
	...
	int dout_hiz;
	struct irq_cfg_v2 irq_config1;
	struct irq_cfg_v2 irq_config2;
	struct classh_cfg_v2 classh_config;
};

struct cs35l41_v2_rst_cache {
	bool extclk_cfg;
	int asp_width;
	int asp_wl;
	int asp_fmt;
...
struct cs35l41_v2_private {
	struct wm_adsp_v2 dsp; /* needs to be first member */
	...
	struct cs35l41_v2_rst_cache reset_cache;
