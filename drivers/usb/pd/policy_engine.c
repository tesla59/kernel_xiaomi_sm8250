...
#else
#define USES_SRC_CAPS_2 (0)
#endif
static const u32 default_src_caps_1[] = { 0x36019096 };	/* VSafe5V @ 1.5A */
static const u32 default_src_caps_2[] = { 0x36019032 };	/* VSafe5V @ 0.5A */
#define default_src_caps \
	(USES_SRC_CAPS_2 ? default_src_caps_2 : default_src_caps_1)
#define default_src_caps_size \
	(USES_SRC_CAPS_2 ? ARRAY_SIZE(default_src_caps_2) : ARRAY_SIZE(default_src_caps_1))
#else
