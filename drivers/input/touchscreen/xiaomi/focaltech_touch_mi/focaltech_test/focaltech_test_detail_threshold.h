...
struct detailthreshold_incell_mi {
	int *invalid_node;
...
struct detailthreshold_mcap_mi {
...
struct detailthreshold_scap_mi {
...
void OnGetTestItemParam_mi(char *strItemName, char *strIniFile, int iDefautValue);
