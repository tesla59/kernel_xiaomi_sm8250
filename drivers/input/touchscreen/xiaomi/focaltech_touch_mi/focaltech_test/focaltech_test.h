...
struct fts_test_data_mi {
	...
	char ini_ic_name[20];
	int ini_keyword_num;
	struct _ini_data_mi *ini_data;
	struct test_funcs_mi *func;
	struct test_item_mi test_item[MAX_TEST_ITEM];
	struct screen_setting_mi screen_param;
	struct detailthreshold_mcap_mi mcap_detail_thr;
	struct detailthreshold_scap_mi scap_detail_thr;
	struct detailthreshold_incell_mi incell_detail_thr;
...
*****************************************************************************/
extern struct test_funcs_mi test_func_ft5452;
extern struct test_funcs_mi test_func_ft8719;
extern struct test_funcs_mi *test_funcs_list[];
extern struct fts_test_data_mi test_data;

int init_test_funcs_mi(u32 ic_type);
u32 fts_ic_table_get_ic_code_from_ic_name_mi(char *strIcName);
...
void fts_set_testitem_mi(unsigned char ucitemcode);
