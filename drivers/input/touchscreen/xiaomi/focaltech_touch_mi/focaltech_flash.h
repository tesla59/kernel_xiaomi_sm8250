...
struct fts_upgrade_mi {
	u8 *fw;
	u32 fw_length;
	u8 *lic;
	u32 lic_length;
	struct upgrade_func_mi *func;
};

struct upgrade_fw_mi {
	u16 vendor_id;
	u8 *fw_file;
	u32 fw_len;
};
...
*****************************************************************************/
extern struct fts_upgrade_mi *fwupgrade_mi;
extern struct upgrade_func_mi upgrade_func_ft8719;
extern struct upgrade_func_mi upgrade_func_ft5452;
