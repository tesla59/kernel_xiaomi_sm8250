...
int gf_fod_parse_dts(struct gf_dev *gf_dev);
void gf_fod_cleanup(struct gf_dev *gf_dev);

int gf_fod_power_on(struct gf_dev *gf_dev);
int gf_fod_power_off(struct gf_dev *gf_dev);

int gf_fod_hw_reset(struct gf_dev *gf_dev, unsigned int delay_ms);
int gf_fod_irq_num(struct gf_dev *gf_dev);
#endif /*__GF_SPI_H*/
