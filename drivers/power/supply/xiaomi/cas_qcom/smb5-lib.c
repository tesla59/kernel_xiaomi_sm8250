...
#ifdef CONFIG_IDT_P9415
extern int idtp9415_op_ble_flag(int en);
#endif
#ifdef CONFIG_IDT_P9415_CAS
extern int idtp9415_cas_op_ble_flag(int en);
#endif
#ifdef CONFIG_IDT_P9418
extern int idtp9418_op_ble_flag(int en);
#endif
				...
				const union power_supply_propval *val)
{
	...
	case BLE_CONNECT:
		if (chg->idtp_psy) {
#ifdef CONFIG_IDT_P9415
			idtp9415_op_ble_flag(1);
#endif
#ifdef CONFIG_IDT_P9415_CAS
			idtp9415_cas_op_ble_flag(1);
#endif
#ifdef CONFIG_IDT_P9418
			idtp9418_op_ble_flag(1);
#endif
		} else {
#ifdef CONFIG_RX1619
			rx_op_ble_flag(1);
	...
	case BLE_DISCONNECT:
		if (chg->idtp_psy) {
#ifdef CONFIG_IDT_P9415
			idtp9415_op_ble_flag(0);
#endif
#ifdef CONFIG_IDT_P9415_CAS
			idtp9415_cas_op_ble_flag(0);
#endif
#ifdef CONFIG_IDT_P9418
			idtp9418_op_ble_flag(0);
#endif
		} else {
#ifdef CONFIG_RX1619
			rx_op_ble_flag(0);
